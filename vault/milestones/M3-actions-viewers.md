...
- [ ] Each workload action works with a confirmation step and reports success/failure to the status bar. (delete M3-09/D115; scale prompt + rollout-restart confirm M3-10/D117; cordon/drain M3-11 + suspend/resume M3-12 remain)
