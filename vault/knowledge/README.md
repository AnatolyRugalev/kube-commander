...
Durable knowledge for the rewrite. When you learn something non-obvious —
about the old code, the Kubernetes API, a library quirk, or a decision — write
it here so the next agent (or a cold-started you) doesn't re-derive it.
